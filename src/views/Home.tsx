...
const Home = () => {
    ...
    return (
        <motion.div className='h-[calc(100vh-73px)] w-full max-w-[1300px] mx-auto flex flex-col justify-start px-[20px] pt-[200px]'
            initial={{ opacity: 0 }}
        ...
        >
            <div>
                ...
                <h1 className='big-heading leading-[1.3]'>Chukwudalu Ayika.</h1>
                <h2 className='big-heading leading-[1.3] text-faintText'>I build things for the web.</h2>
                <StyledTypingEffect ref={el} className='md-texts max-w-[540px] min-h-[120px] md:min-h-[180px] mt-[30px] md:text-[20px] text-[16px] text-faintText'></StyledTypingEffect>
